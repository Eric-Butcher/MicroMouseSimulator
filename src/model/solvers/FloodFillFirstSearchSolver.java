...
public class FloodFillFirstSearchSolver extends Solver {
    ...
    public FloodFillFirstSearchSolver(Grid grid) {
        super(grid);
    }

    public FloodFillFirstSearchSolver(Grid grid, Cell startPoint, ArrayList<Cell> endPoints) {
